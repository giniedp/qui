...
import { registerComponent, getModelValue } from './core'
import {
  call,
  clamp,
  use,
 ...
 * @public
 */
export interface PadModel<T = unknown>
...
registerComponent<PadAttrs>('pad', (vnode) => {
  let kx: any
  let ky: any
  ...
  function fetchValue(node: m.Vnode<PadAttrs>) {
